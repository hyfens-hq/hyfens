...
/// The production Flutter widget ABI keeps the framework-owned
/// [BuildContext] in the host isolate. It is passed opaquely to the
/// interpreter and is never serialized into a patch container.
const E0FunctionSignature e0FlutterWidgetBuildSignature = E0FunctionSignature(
  parameters: <E0ValueSchema>[E0ValueSchema.buildContext],
  returnSchema: e0WidgetDescriptionSchema,
);

/// Common framework constructors available to a generated Flutter host.
///
/// The list is intentionally small and immutable. A patch may compose these
/// host-owned widgets, but it cannot construct arbitrary framework objects or
/// cross the native/resource boundary.
final List<E0WidgetFactoryDescriptor> e0StandardFlutterWidgetFactories =
    List.unmodifiable(<E0WidgetFactoryDescriptor>[
      ...
      E0WidgetFactoryDescriptor(
        ...
        properties: const <E0WidgetPropertyDescriptor>[
          E0WidgetPropertyDescriptor(
            name: 'onPressed',
            schema: E0ValueSchema.hostCallback,
          ),
        ],
        minChildren: 1,
        maxChildren: 1,
