...
void main() {
  ...
  group('release metadata', () {
    ...
    test('uses platform-specific archive names and formats', () {
      ...
      final windows = parseArtifactFileName('hyfens-0.1.9-windows-x64.zip');
      expect(windows.platform, 'windows');
      expect(windows.architecture, 'x64');
      expect(
        () => parseArtifactFileName('hyfens-0.1.9-linux-x64.zip'),
    ...
    test(
      ...
      () {
        ...
        for (final entry in targets.entries) {
          ...
          final archiveName =
              'hyfens-0.1.9-$platform-$architecture.' + entry.value;
          ...
          expect(
            ...
            'hyfens-0.1.9-$platform-$architecture',
          );
        }
      },
    );
